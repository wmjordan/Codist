...
abstract class SemanticCommandBase
{
	...
	protected bool MatchNamespace => Options.MatchFlags(CommandOptions.MatchNamespace);
	...
	protected SymbolNamespaceFilter MakeNamespaceFilterFromOption(CommandOptions options) {
		return options.MatchFlags(CommandOptions.MatchNamespace) ? new SymbolNamespaceFilter(Symbol) : default;
	}
