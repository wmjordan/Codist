...
namespace Codist
{
	static partial class CodeAnalysisHelper
	{
		...
		internal const SyntaxKind ConstantPattern = (SyntaxKind)9002;
		internal const SyntaxKind CasePatternSwitchLabel = (SyntaxKind)9009;
		...
		internal const SyntaxKind DiscardPattern = (SyntaxKind)9024;
		...
		internal const SyntaxKind TypePattern = (SyntaxKind)9030;
		internal const SyntaxKind OrPattern = (SyntaxKind)9031;
		internal const SyntaxKind AndPattern = (SyntaxKind)9032;
		internal const SyntaxKind NotPattern = (SyntaxKind)9033;
		internal const SyntaxKind SlicePattern = (SyntaxKind)9034;
