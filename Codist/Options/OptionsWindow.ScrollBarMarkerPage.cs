							...
							new WrapPanel {
								Children = {
									new StackPanel().MakeHorizontal().Add(
										...
										new ColorButton(mo.MatchMarker, R.T_Color, UpdateMatchColor).ReferenceStyle(VsResourceKeys.ButtonStyleKey).Set(ref _MatchColorButton)
									),
									new StackPanel().MakeHorizontal().Add(
										...
										new ColorButton(mo.CaseMismatchMarker, R.T_Color, UpdateCaseMismatchColor).ReferenceStyle(VsResourceKeys.ButtonStyleKey).Set(ref _CaseMismatchColorButton)
									),
								}
							},
					...
					new WrapPanel {
						Children = {
							new StackPanel().MakeHorizontal().Add(
								...
								new ColorButton(so.ReferenceMarker, R.T_Color, UpdateSymbolReferenceColor).ReferenceStyle(VsResourceKeys.ButtonStyleKey).Set(ref _SymbolReferenceButton)
							),
							new StackPanel().MakeHorizontal().Add(
								...
								new ColorButton(so.WriteMarker, R.T_Color, UpdateSymbolWriteColor).ReferenceStyle(VsResourceKeys.ButtonStyleKey).Set(ref _SymbolWriteButton)
								),
							new StackPanel().MakeHorizontal().Add(
								...
								new ColorButton(so.SymbolDefinition, R.T_Color, UpdateSymbolDefinitionColor).ReferenceStyle(VsResourceKeys.ButtonStyleKey).Set(ref _SymbolDefinitionButton)
								)
						}
					}.WrapMargin(SubOptionMargin)
				);
