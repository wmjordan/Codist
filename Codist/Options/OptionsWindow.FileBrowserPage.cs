...
sealed partial class OptionsWindow
{
	sealed class FileBrowserPage : OptionPageFactory
	{
		...
		{
			readonly OptionBox<FileBrowserOptions> _ShowLabelsBox, _ShowSolutionProjectsBox, _ShowSolutionFolderBox, _ShowProjectFolderBox, _ShowDocumentFolderBox, _ShowOpenedDocumentsBox;
