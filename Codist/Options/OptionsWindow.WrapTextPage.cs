				...
				SetContents(new Note(R.OT_WrapTextNote),
					...
					new Grid {
						...
						Children = {
							...
							new Grid {
								...
								Children = {
									...
									WpfHelper.Stack(true, 
										...
										new HelpMessageButton(IconIds.Info, R.OT_WrapTextIndicatorTip),
										...
										new HelpMessageButton(IconIds.Info, R.OT_WrapTextPlaceholderTip)
							...
							new HelpMessageButton(IconIds.Info, R.OT_WrapTextPatternTip).SetValue(Grid.SetColumn, 1).SetValue(Grid.SetRow, 2)
						}
					}
				);
