...
namespace Codist.Margins
{
	...
	sealed class CSharpMembersMarginElement : FrameworkElement
	{
		...
		public CSharpMembersMarginElement(IWpfTextView textView, IVerticalScrollBar verticalScrollbar, CSharpMembersMarginFactory factory) {
			...
			_MemberMarker = new MemberMarker(textView, verticalScrollbar, factory, this);
		...
		sealed class MemberMarker
		{
			...
			readonly CSharpMembersMarginFactory _Factory;
			readonly CSharpMembersMarginElement _Element;
			readonly Pen _EmptyPen = new Pen();

			public MemberMarker(IWpfTextView textView, IVerticalScrollBar verticalScrollbar, CSharpMembersMarginFactory factory, CSharpMembersMarginElement element) {
				_TextView = textView;
		...
		sealed class SymbolReferenceMarker
		{
			...
			public SymbolReferenceMarker(IWpfTextView textView, IVerticalScrollBar verticalScrollbar, CSharpMembersMarginElement element) {
				_View = textView;
				_ScrollBar = verticalScrollbar;
				_Element = element;
				HookEvents();
